<?php
    ...
    $showQuery = "SELECT * FROM threads WHERE category = 'tech'";
...
<body>
    ...
    <div class="banner">
        <img src="../assets/techbanner.jpg" alt="Technology board banner">
    </div>

    <?php if(isset($_SESSION['sess_user_name'])) : ?>
        <div class="banner">
            <h3><a href="insertTech.php" style="text-decoration:none;">[ Create Thread ]</a></h3>
        </div>
    <?php else: ?>
        <div class="banner">
        ...
        <section class="container">
            ...
            <div class="card">
                ...
                <div class="content">
                    ...
                    <h2 style="color: green;"><?= $row['title'] ?></h2>
